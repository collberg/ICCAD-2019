...
\newcommand{\ToReviewer}[1]{\begin{center}\colorbox{yellow}{\parbox{7cm}{#1}}\end{center}}
...
%\acmSubmissionID{390X-G3C9D6J5D3}
...
\begin{document}
\input{abstract.tex}
\keywords{Obfuscation, tigress, IoT, power, energy, RPi, virtualize, MiBench, Keysight SMU}
